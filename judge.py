...
if __name__ == '__main__':
    ...
    tgt1_pub = rospy.Publisher(groupid+'/receivedtarget1', Int16, queue_size=3)
    tgt2_pub = rospy.Publisher(groupid+'/receivedtarget2', Int16, queue_size=3)
    tgt3_pub = rospy.Publisher(groupid+'/receivedtarget3', Int16, queue_size=3)
